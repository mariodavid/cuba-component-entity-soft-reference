...
public class DdcsefTestContainer extends TestContainer {

    public DdcsefTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/cuba/softentityreference/app.properties",
    ...
    public static class Common extends DdcsefTestContainer {

        public static final DdcsefTestContainer.Common INSTANCE = new DdcsefTestContainer.Common();
